INSERT INTO categoria (nome) VALUES ('Salões de Beleza');
INSERT INTO categoria (nome) VALUES ('Barbearias');
INSERT INTO categoria (nome) VALUES ('Manicure & Nail Designer');
INSERT INTO categoria (nome) VALUES ('Esteticistas');
INSERT INTO categoria (nome) VALUES ('Sobrancelhas & Cílios');

INSERT INTO funcao (nome_funcao) VALUES ('Cabelereiro');
INSERT INTO funcao (nome_funcao) VALUES ('Barbeiro');
INSERT INTO funcao (nome_funcao) VALUES ('Manicure');
INSERT INTO funcao (nome_funcao) VALUES ('Esteticista');
INSERT INTO funcao (nome_funcao) VALUES ('Recepcionista');
...
VALUES (1, 2, 'https://alexandrecarvalho.com/wp-content/uploads/2019/12/outstonelogo.jpg', '50438712000265', 'contato1@minhanovaempresa.com', 'Minha Nova Empresa', '+5511999999999');
...
VALUES (NULL, 1, 1,  1, 0, 12345678905, 'joao.silva@example.com', '', 1, NULL, 'João da Silva', NULL, '$2a$10$jTFvRNxv.JBvUvLtCFSeR.UY2O/ugXv.kKYOIuKnwz4GgHKxzRIN.');

INSERT INTO usuarios (data_nascimento, fk_empresa, fk_endereco,  representante, tipos_de_usuario, cpf, email_pessoa, firebase_uid, fk_funcao, genero, nome_pessoa, numero_telefone, senha)
VALUES (NULL, 1, 1,  0, 1, '12345678902', 'maria.silva@example.com', '', 2, 'F', 'Maria da Silva', NULL, '$2a$10$jTFvRNxv.JBvUvLtCFSeR.UY2O/ugXv.kKYOIuKnwz4GgHKxzRIN.');
...
VALUES ('2024-10-04 10:00:00', 1, 1, 1);

INSERT INTO agendamento (data_hora, fk_cliente, fk_agenda, fk_servico)
VALUES ('2024-10-04 10:30:00', 2, 1, 2);

INSERT INTO agendamento (data_hora, fk_cliente, fk_agenda, fk_servico)
VALUES ('2024-10-04 11:00:00', 1, 1, 3);

INSERT INTO agendamento (data_hora, fk_cliente, fk_agenda, fk_servico)
VALUES ('2024-10-04 13:00:00', 1, 2, 1);

INSERT INTO agendamento (data_hora, fk_cliente, fk_agenda, fk_servico)
VALUES ('2024-10-04 14:30:00', 2, 2, 2);

INSERT INTO agendamento (data_hora, fk_cliente, fk_agenda, fk_servico)
VALUES ('2024-10-04 15:00:00', 1, 2, 3);

INSERT INTO agendamento (data_hora, fk_cliente, fk_agenda, fk_servico)
VALUES ('2024-10-04 16:00:00', 1, 3, 1);

INSERT INTO agendamento (data_hora, fk_cliente, fk_agenda, fk_servico)
VALUES ('2024-10-04 17:30:00', 2, 3, 2);

INSERT INTO agendamento (data_hora, fk_cliente, fk_agenda, fk_servico)
VALUES ('2024-10-04 18:00:00', 1, 3, 3);


INSERT INTO agendamento (data_hora, fk_cliente, fk_agenda, fk_servico)
VALUES ('2024-10-03 18:00:00', 1, 3, 3);


INSERT INTO agendamento (data_hora, fk_cliente, fk_agenda, fk_servico)
VALUES ('2024-10-03 10:00:00', 1, 3, 3);
